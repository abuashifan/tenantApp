...
export function InventoryPageGate({ permission, children }: { permission: string | readonly string[]; children: ReactNode }) {
    ...
    fetchAndStorePermissions()
      .then((permissions) => {
        if (!hasPermission(permissions, permission)) {
          setError('You do not have permission to access this inventory page.');
          return;
        }
        setAllowed(true);
      })
  ...
  if (loading) return <LoadingState title="Checking inventory access" />;
