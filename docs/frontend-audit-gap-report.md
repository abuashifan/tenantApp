...
- [x] AR ledger detail by customer/invoice aktif di Vue: Customer Summary dan Open Invoices kini memakai service AR real dan menyediakan drilldown ke `/sales/ar/customers/:customerId/ledger` serta `/sales/ar/invoices/:invoiceId/ledger`. Detail/DoD: `docs/point-5-ar-ap-ledger-detail-pages.md`.
...
- [x] AP ledger detail by vendor/bill aktif di Vue: Vendor Summary dan Open Bills kini memakai service AP real dan menyediakan drilldown ke `/purchase/ap/vendors/:vendorId/ledger` serta `/purchase/ap/bills/:billId/ledger`. Detail/DoD: `docs/point-5-ar-ap-ledger-detail-pages.md`.
