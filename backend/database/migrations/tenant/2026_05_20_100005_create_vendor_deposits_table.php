...
return new class extends Migration
{
    ...
    {
        Schema::create('vendor_deposits', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('refund_journal_entry_id')->nullable();
            ...
            $table->timestamps();
            $table->index(['vendor_id', 'deposit_date']);
    ...
    {
        Schema::dropIfExists('vendor_deposits');
    }
};
