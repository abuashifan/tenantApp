...
class StoreSalesOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'header_discount_type' => ['nullable', 'in:percent,fixed_amount'], 'header_discount_value' => ['nullable', 'numeric', 'min:0'], 'notes' => ['nullable', 'string'], 'internal_notes' => ['nullable', 'string'],
