...
class BillingInvoiceController extends Controller
{
    ...
    public function index(Request $request): JsonResponse { return $this->successResponse($this->service->list($request->query()), 'Billing invoices retrieved successfully'); }
