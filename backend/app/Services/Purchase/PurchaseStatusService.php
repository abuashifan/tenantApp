...
class PurchaseStatusService
{
    ...
    {
        return (array) config('purchase_workflow.statuses', []);
    }

    public function reportable(): array
    {
        return (array) config('purchase_workflow.reportable_statuses', []);
    }

    public function hidden(): array
    {
        return (array) config('purchase_workflow.hidden_statuses', []);
    }
