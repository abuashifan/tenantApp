...
export const backendResourceFormConfigs: Record<string, ResourceFormConfig> = {
  ...
  '/inventory/stock-adjustments': {
    ...
    lineItems: { key: 'lines', title: 'Adjustment Lines', minRows: 1, columns: [{ key: 'product_id', label: 'Product ID', type: 'number' }, { key: 'warehouse_id', label: 'Warehouse ID', type: 'number' }, { key: 'adjustment_type', label: 'Type' }, { key: 'quantity', label: 'Quantity', type: 'number' }, { key: 'unit_cost', label: 'Unit Cost', type: 'money' }, { key: 'reason', label: 'Reason' }, { key: 'department_id', label: 'Dept ID', type: 'number' }, { key: 'project_id', label: 'Project ID', type: 'number' }], defaultRow: { product_id: null, warehouse_id: null, adjustment_type: 'increase', quantity: 1, unit_cost: 0, reason: '', department_id: null, project_id: null } },
